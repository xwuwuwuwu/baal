...
public class DownloaderAlert {

    private static final String ApplicationInsightQueryUrl = "ApplicationInsightQueryUrl";
    private static final String ApplicationInsightAPIKey = "ApplicationInsightAPIKey";
    private static final String AlertEmails = "AlertEmails";
    private static final String countFunctionName = "FunctionDistinctCount";
    private static final String frequencyFunctionName = "FunctionFrequencyCount";
    ...
    public static void run(
        ...
        int threshold = jsonObject.get(Downloader.THRESHOLD).getAsInt();
        String deployAt = jsonObject.get(Downloader.DEPLOY_AT).getAsString();
        ...
        String countResult = executeQuery(countFunctionName, timespan);
        ...
        String frequencyResult = executeQuery(frequencyFunctionName, timespan);
    ...
    private static void sendEmailViaSendGrid(String mailBody) {
        ...
        String emails = System.getenv(AlertEmails);
...
//            System.out.println(response.getHeaders());
    ...
    private static String executeQuery(String funcName, String timespan) {
        String queryUrl = System.getenv(ApplicationInsightQueryUrl);
        String apiKey = System.getenv(ApplicationInsightAPIKey);
